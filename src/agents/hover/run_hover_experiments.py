"""
HoVer Experiment Runner with Continuation System
"""
...
from hover_utils import WEBTHINK_PROMPT_TEMPLATE
from react_agent import run_react
from nexus_wrapper import run_nexus


class HoVerExperimentRunner:
    ...
    def __init__(
        ...
        results_base_dir: str = "../../../results/hover",
        seed: int = 42,
        ...
        self.max_dev_examples = 1126  # 2-hop dev examples
        ...
        print("="*70, flush=True)
        print(f"[EXPERIMENT] HoVer 2-Hop Agent Evaluation", flush=True)
        print("="*70, flush=True)
...
def main():
    parser = argparse.ArgumentParser(description="Run HoVer experiments with continuation support")

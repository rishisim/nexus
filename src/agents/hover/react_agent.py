"""
ReAct Agent for HoVer

Standard single-trace ReAct agent for multi-hop claim verification (SUPPORTED/NOT_SUPPORTED).
"""
...
from hover_utils import run_single_trace, WEBTHINK_PROMPT_TEMPLATE
...
if __name__ == '__main__':
    print("\n[TEST] Running ReAct agent test on HoVer\n")

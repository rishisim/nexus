"""
ReAct Agent for Bamboogle

Standard single-trace ReAct agent for multi-hop QA.
"""
...
from bamboogle_utils import run_single_trace, WEBTHINK_PROMPT_TEMPLATE
...
if __name__ == '__main__':
    print("\n[TEST] Running ReAct agent test on Bamboogle\n")

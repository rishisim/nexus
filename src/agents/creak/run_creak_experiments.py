"""
CREAK Experiment Runner with Continuation System
"""
...
from creak_utils import WEBTHINK_PROMPT_TEMPLATE
from react_agent import run_react
from nexus_wrapper import run_nexus


class CREAKExperimentRunner:
    ...
    def __init__(
        ...
        results_base_dir: str = "../../../results/creak",
        seed: int = 42,
        ...
        print("="*70, flush=True)
        print(f"[EXPERIMENT] CREAK Agent Evaluation", flush=True)
        print("="*70, flush=True)
...
def main():
    parser = argparse.ArgumentParser(description="Run CREAK experiments with continuation support")

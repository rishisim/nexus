"""
PopQA Experiment Runner with Continuation System
"""
...
from popqa_utils import WEBTHINK_PROMPT_TEMPLATE
from react_agent import run_react
from nexus_wrapper import run_nexus


class PopQAExperimentRunner:
    ...
    def __init__(
        ...
        results_base_dir: str = "../../../results/popqa",
        seed: int = 42,
        ...
        print("="*70, flush=True)
        print(f"[EXPERIMENT] PopQA Agent Evaluation", flush=True)
        print("="*70, flush=True)
...
def main():
    parser = argparse.ArgumentParser(description="Run PopQA experiments with continuation support")

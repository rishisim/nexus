"""
ReAct Agent for PopQA

Standard single-trace ReAct agent for entity-centric QA.
"""
...
from popqa_utils import run_single_trace, WEBTHINK_PROMPT_TEMPLATE
...
if __name__ == '__main__':
    print("\n[TEST] Running ReAct agent test on PopQA\n")

"""Frozen paired analysis for the REALM 2026 harmonized corrective study."""
...
from .realm26_harmonized_protocol import DATASETS, DEFAULT_PROTOCOL_PATH, FRAMEWORKS, load_manifest, load_protocol
...
def analyze(protocol_path: str | Path, results_root: Path) -> Dict[str, Any]:
    ...
    result: Dict[str, Any] = {
        "analysis_schema_version": "realm26-harmonized-analysis-v1",
        ...
        "separation_statement": "This development-only corrective study is separate from, and does not reopen or replace, the original documented selector gate.",
    }
...
def render_memo(analysis: Mapping[str, Any]) -> str:
    ...
    return f"""# REALM 2026 prompt/context-harmonized corrective replication

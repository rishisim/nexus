"""Execute the frozen REALM 2026 prompt/context-harmonized corrective study."""
...
from .realm26_harmonized_methods import METHODS
from .realm26_harmonized_data import HarmonizedEnvFactory
from .realm26_harmonized_protocol import (
    DATASETS,
...
RESULT_SCHEMA_VERSION = "realm26-harmonized-result-v1"
    ...
    def __init__(self, path: Path, protocol_fingerprint: str, cap_usd: float):
        ...
        if path.exists():
            ...
            self.data = {
                ...
                "schema_version": "realm26-harmonized-spend-ledger-v1",
            }
            self._write()
...
class HarmonizedRunner:
    ...
    def run(self, phase: str) -> None:
        ...
        if phase == "smoke":
            ...
            print(f"[SMOKE PASS] exact binding/telemetry validated; spend USD {self.ledger.actual_spend:.6f}; outcomes not summarized.")
        else:
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    HarmonizedRunner(args.protocol).run(args.phase)
